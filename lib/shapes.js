...
class Triangle extends Shape {
    render() {
        return (`
        <svg xmlns="http://www.w3.org/2000/svg" width="200" height="200">
            <polygon points='100,0 0,200 200,200' fill='${this.shapeColor}' fill-opacity='1' />
            <text x='50%' y='50%' fill='${this.textColor}' text-anchor='middle' font-size='40' dominant-baseline='middle'>${this.text}</text>
        </svg>`
        );
    }
}
